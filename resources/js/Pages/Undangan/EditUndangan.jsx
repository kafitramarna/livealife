...
export default function EditUndangan({ auth, undangan }) {
    const { data, setData, put, processing, errors} = useForm({
        pengantin_pria: undangan.pengantin_pria,
        pengantin_wanita: undangan.pengantin_wanita,
        tempat_acara: undangan.tempat_acara,
        nama_gedung: undangan.nama_gedung,
        alamat: undangan.alamat,
        kota: undangan.kota,
        provinsi: undangan.provinsi,
        tanggal_acara: undangan.tanggal_pernikahan,
        jam_mulai_acara: undangan.waktu_pernikahan,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("my-undangan.update", undangan.slug), data);
    };

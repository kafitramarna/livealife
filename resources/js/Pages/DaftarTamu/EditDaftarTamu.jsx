...
export default function EditDaftarTamu({ auth, undangan,daftar_tamu }) {
    const { data, setData, put, processing, errors } = useForm({
        nama: daftar_tamu.nama,
        no_hp: daftar_tamu.no_hp,
        no_wa: daftar_tamu.no_wa,
        ceklis: false
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("daftar-tamu.update", [undangan.slug,daftar_tamu.slug]), data);
    };
    const handleCeklis=()=>{
        // setIsSama(!isSama)
                                    ...
                                    <div className="sm:col-span-3">
                                        ...
                                        <div className="mt-2">
                                            <input
                                                ...
                                                name="no_wa"
                                                id="no_wa"
                                                value= {!data.ceklis?data.no_wa:data.no_hp}
                                                onChange={handleChange}
                                                placeholder="ex. 081234567890"
